...
namespace ConsoleInterface
{
    class Program
    {
        ...
        static void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IAccountService, AccountService>(c =>
                new AccountService(c.GetRequiredService<IRepository<Account>>(),
            ...
            services.AddTransient<ICommand, GetSkillsCommand>(c =>
                new GetSkillsCommand(c.GetRequiredService<ISkillService>(), 
